...
class CompositionTests(unittest.TestCase):
    ...
    def test_explicit_profile_composes_actual_h3_lease_attestation_and_runtime(self) -> None:
        ...
        self.assertTrue(callable(composition.approval_authority_service._existing_endpoint_revalidator))
        self.assertIs(composition.approval_authority_service._existing_endpoint_revalidator.driver, composition.driver)
        self.assertIs(composition.approval_authority_service._existing_endpoint_revalidator.trust_context, composition.trust_context)
